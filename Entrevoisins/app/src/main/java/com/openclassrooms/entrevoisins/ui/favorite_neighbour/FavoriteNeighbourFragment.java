...
public class FavoriteNeighbourFragment extends Fragment {
    ...
    private List<Neighbour> mNeighbours = FavoriteNeighbourManagement.getFavoriteNeighbourList();
    ...
    public void onDeleteNeighbour(DeleteNeighbourEvent event) {
        FavoriteNeighbourManagement.addOrRemoveToFavoriteList(event.neighbour,mContext);
        initList();
    }
