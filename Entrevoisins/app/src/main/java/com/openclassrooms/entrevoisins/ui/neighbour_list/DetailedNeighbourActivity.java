...
import com.openclassrooms.entrevoisins.ui.favorite_neighbour.FavoriteNeighbourManagement;
...
public class DetailedNeighbourActivity extends AppCompatActivity {
    ...
    private void displayDataFromIntent(Neighbour neighbour) {
        ...
        statueOfStar(neighbour);

    }

    private void statueOfStar(Neighbour neighbour) {
        if(FavoriteNeighbourManagement.starStatue(neighbour)){
